...
const navigationIconItems = [
  {
    icon: RiHome6Line,
    labelTooltip: "Dashboard",
  },
  {
    icon: RiArchiveStackLine,
    labelTooltip: "Eventos",
  },
  {
    icon: RiGroup3Line,
    labelTooltip: "Usuários",
  },
  {
    icon: RiAppsLine,
    labelTooltip: "Categorias",
  },
  {
    icon: RiMailSendLine,
    labelTooltip: "Newsletter",
  },
];
    ...
    <div className="w-full h-dvh bg-[#f5f5f5] grid grid-cols-[4%_96%]">
      <header className="border-r py-5 flex bg-white flex-col items-center justify-between border-zinc-200">
        ...
        <nav className="h-full flex flex-col items-center justify-center gap-10">
          {navigationIconItems.map((item, index) => (
            <button key={index}>
              <item.icon />
            </button>
          ))}
        ...
        <section id="dashboard" className="p-10">
          <header className="flex items-center justify-between">
            ...
            <div>
              <button
                ...
                className="px-5 py-1.5 gap-2 border bg-white  hover:bg-zinc-100 transition-all border-gray-200 rounded-lg flex items-center"
              >
                <Image
                  src={"/img/avatar.png"}
                  alt={"Avatar"}
          ...
          <div className="mt-10 grid grid-cols-4 gap-6 ">
            {metrics.map((item, index) => (
              <div className="bg-white relative border overflow-hidden border-zinc-200 p-6 rounded-2xl">
                <header className="flex items-center justify-between">
