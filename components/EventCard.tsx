...
export function EventCard({ event, className }: EventCardProps) {
  return (
    <div
      className={cn(
        "h-96 bg-transparent shrink-0 overflow-hidden flex flex-col justify-between border border-gray-200 shadow-2xl shadow-gray-200 z-20 rounded-3xl w-80",
        className,
      )}
    >
      <header
      ...
      >
        <div className="flex w-full items-center gap-4 justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="text-white rotate-90 opacity-50 hover:opacity-100 transition-opacity">
              <RiMore2Fill />
            </button>
          </div>
        </div>
