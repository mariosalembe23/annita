      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-50 min-w-44 bg-white dark:bg-zinc-900 rounded-xl shadow-xl dark:shadow-black/40 border border-gray-100 dark:border-zinc-700 py-1 overflow-hidden"
